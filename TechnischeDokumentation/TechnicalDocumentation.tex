...
\textit{Totale Ordnung} & Eine totale Ordnung liegt vor, wenn sich alle Elemente in eindeutiger Weise sortieren lassen (wenn jedes Elemente immer kleiner gleich (<=) dem nächsten Element ist). z.B. die endliche Menge der natürlichen Zahlen.\\[0.2cm]
