...
\bibitem[MSDN, 2015]{msdn}"MSDN - Memory Management and Garbage Collection", https://msdn.microsoft.com/de-de/library/0xy59wtx(v=vs.110).aspx, 08.2012
\bibitem[MONO, 2015]{monocecil} "Mono.Cecil Library",\\ http://www.mono-project.com/docs/tools+libraries/libraries/Mono.Cecil/ 
\end{thebibliography}
\end{document}
